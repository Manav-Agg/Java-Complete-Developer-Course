...
//                LocalDate.of(2022, Month.JUNE, 26));
//        TodoItem item2 = new TodoItem("Doctor's Appointment", "See Dr. Smith at 123 Main Street. Bring PaperWork",
//                LocalDate.of(2022, Month.JULY, 23));
//        TodoItem item3 = new TodoItem("Finish design proposal for client", "I promised Mike i'd email website mockups by Friday 22 June",
//                LocalDate.of(2022, Month.JUNE, 22));
//        TodoItem item4 = new TodoItem("Pickup Doug at the train station", "Doug's arriving on May 23 on the 5:00 train",
